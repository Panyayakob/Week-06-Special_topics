...
ช่วยแบ่งแยกความรับผิดชอบของโค้ด ทำให้ง่ายต่อการดูแล แก้ไข และทดสอบ
2. **CMakeLists.txt Management**: การเพิ่มไฟล์ source ใหม่ต้องแก้ไขอะไรบ้าง?
ต้องเพิ่มชื่อไฟล์ source ใหม่ใน SRCS หรือ REQUIRES เพื่อให้ build system รู้จักไฟล์นั้น
3. **Header Files**: บทบาทของไฟล์ .h คืออะไร และทำไมต้องมี?
ประกาศฟังก์ชันและโครงสร้างข้อมูล ให้ไฟล์อื่น ๆ รู้จักและเรียกใช้งานโค้ดใน source file ได้
4. **Include Directories**: เหตุใด CMakeLists.txt ต้องระบุ INCLUDE_DIRS?
บอกให้คอมไพเลอร์รู้ว่าต้องไปหาไฟล์ header ที่ไหนเพื่อเชื่อมโยงระหว่างไฟล์ต่าง ๆ
5. **Git Ignore**: ไฟล์ .gitignore ช่วยอะไรในการจัดการ ESP32 project?
ช่วยป้องกันไฟล์ชั่วคราวหรือไฟล์ build ที่ไม่จำเป็นต้องเก็บใน git ลดความยุ่งยากและขนาด repo
6. **Task Management**: การใช้ FreeRTOS task ในโมดูล LED ช่วยอะไร?
FreeRTOS task ช่วยให้โมดูล LED ทำงานแบบ concurrent และแยกส่วนจากโค้ดหลัก เพิ่มประสิทธิภาพและความยืดหยุ่น
7. **Code Organization**: ข้อดีของการแยกโมดูล sensor, display, led เป็นไฟล์แยกคืออะไร?
แยกโมดูลทำให้โค้ดอ่านง่าย แก้ไขง่าย และสามารถพัฒนาหรือทดสอบแยกส่วนได้ ลดความซับซ้อน
...
- การทำงาน: อ่านค่าจากเซนเซอร์แล้วส่งข้อมูลไป
ให้ระบบประมวลผลหรือแสดงผล
